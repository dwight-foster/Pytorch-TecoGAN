...
video_data_dict = {
    ...
    "163736142": [120, 400, 700, 1000, 1300, 1500, 1750, 2150, 2390, 2550, 3100, 3400, 3800, 4100, 4400, 4800, 5100,
                  5500, 5800, 6300],  # 25
    "189872577": [0, 170, 340, 4380, 4640, 5140, 7300, 7470, 7620, 7860, 9190, 9370],  # 26
    "181180995": [30, 160, 400, 660, 990, 2560, 2780, 3320, 3610, 5860, 6450, 7260, 7440, 8830, 9020, 9220, 9390, ],
    # 28
...
for keys in video_data_dict:
    ...
    for start_fr in video_data_dict[keys]:
        ...
        gen_frames(tar_vid_output, tar_dir, info_dict["width"], info_dict["height"], start_fr, Flags.duration,
                   saveframes)
        cur_id = cur_id + 1
